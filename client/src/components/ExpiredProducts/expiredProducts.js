...
export default function ExpiredProducts({ productList }) {
	...
	// const expiredProducts = productList.filter(product => product.status === 'EXPIRED')
	// const expiringSoon = productList.filter(product => product.status === 'EXPIRING SOON')
	...
	return (
		<section className="products">
			...
			{currentTab === 'expired' && <ProductList products={expiredProducts} />}
			{currentTab === 'expiringSoon' && <ProductList products={expiringSoon} />}
		</section>
	);
}
